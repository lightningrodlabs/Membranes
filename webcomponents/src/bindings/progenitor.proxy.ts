...
// @ts-ignore
import {PROGENITOR_THRESHOLD_NAME, CrudType, ProgenitorThresholdEntry, ClaimRoleInput, ClaimThresholdInput, HasRoleInput, Membrane, MembraneCrossedClaim, MembraneInput, MembraneRole, MembraneThreshold, Privilege, ProgenitorThresholdZomeProperties, RoleClaim, SignedActionHash, ThresholdReachedProof, ThresholdType, } from './progenitor.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
