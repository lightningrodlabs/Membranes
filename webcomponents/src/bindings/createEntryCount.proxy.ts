...
// @ts-ignore
import {CREATE_ENTRY_COUNT_THRESHOLD_NAME, CreateEntryCountThresholdEntry, CrudType, ClaimRoleInput, ClaimThresholdInput, CreateEntryCountThreshold, GetCreateCountInput, HasRoleInput, Membrane, MembraneCrossedClaim, MembraneInput, MembraneRole, MembraneThreshold, MyAppEntryType, Privilege, RoleClaim, SignedActionHash, ThresholdReachedProof, ThresholdType, } from './createEntryCount.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
...
export class CreateEntryCountProxy extends ZomeProxy {
  ...
  async publishCreateEntryCountThreshold(th: CreateEntryCountThreshold): Promise<EntryArray> {
    return this.call('publish_CreateEntryCount_threshold', th);
  }

  async getThresholdCreateEntryCount(eh: EntryArray): Promise<CreateEntryCountThreshold | null> {
  ...
  async claimThresholdCreateEntryCount(input: ClaimThresholdInput): Promise<ActionArray | null> {
