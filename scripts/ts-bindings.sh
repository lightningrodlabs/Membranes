...
zits --default-zome-name zThreshold_Progenitor -i crates/threshold_Progenitor_types -i crates/threshold_Progenitor_integrity -i crates/threshold_Progenitor -o webcomponents/src/bindings/progenitor.ts
